...
네이버에서, 이후에는 http://zetablog.tistory.com의 티스토리 블로그로 다양한 글을
...
사실 https://github.com/nielsenramon/chalk에서 시키는대로 하면 다 된다! 그런데 이 테마에서는 기본적으로 $$\LaTeX$$ 지원이 되지를 않아, 이를 설정해주기 위해...
...
https://helloworldpark.github.io/jekyll/update/2016/12/18/Github-and-Latex.html를 참고하였다.
...
간단한 Googling을 통해 https://github.community/t5/GitHub-Pages/Github-forgets-about-my-custom-domain-every-time-I-update-the/td-p/470를 찾았다.
...
Disqus 댓글 지원은 https://xho95.github.io/blog/jekyll/disqus/migration/2017/01/20/Add-Disqus-to-Jekyll.html을 참고했다.
